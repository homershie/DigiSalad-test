...
<template>
  <header
    ...
    :class="[
      ...
      isMenuOpen && '-translate-y-full opacity-0 pointer-events-none',
    ]"
  >
    <nav class="flex items-center justify-between px-6 min-h-[100px] md:px-[60px] py-4">
      ...
      <div class="flex items-center gap-3 md:gap-6">
        ...
        <a
          class="w-15 h-15 cursor-pointer rounded-full hover:bg-black/10 transition-colors duration-300 flex items-center justify-center"
          :class="isScrolled ? 'text-brand-dark' : 'text-white'"
